    ...
    return (
        <div className='bg-[#F7F7F7] px-4 rounded-md mt-12'>
            <div className='flex items-center justify-between mt-6 bg-[#F7F7F7] p-4'>
                <h1 className='text-[#246545] text-[20px] font-semibold'>অভিভাবকের তথ্য</h1>
                <div>
            ...
            <div className='mt-6 bg-[#F7F7F7]'>
                <div className='border-[1px] border-gray-200 relative bg-[#F7F7F7]'>
                    <h1 className='text-[#246545] absolute top-1/2 left-0 -translate-y-1/2 pr-4 bg-[#F7F7F7] py-1 font-sembold text-[18px]'>পিতার তথ্য</h1>
                </div>
            </div>
            ...
            <div className='mt-6 bg-[#F7F7F7]'>
                <div className='border-[1px] border-gray-200 relative bg-[#F7F7F7]'>
                    <h1 className='text-[#246545] absolute top-1/2 left-0 -translate-y-1/2 pr-4 bg-[#F7F7F7] py-1 font-sembold text-[18px]'>মাতার তথ্য</h1>
                </div>
            </div>
            <div className='flex items-center justify-start gap-8 mt-4'>
                <div className='w-full'>
            ...
            <div className='mt-6 bg-[#F7F7F7]'>
                <div className='border-[1px] border-gray-200 relative bg-[#F7F7F7]'>
                    <h1 className='text-[#246545] absolute top-1/2 left-0 -translate-y-1/2 pr-4 bg-[#F7F7F7] py-1 font-sembold text-[18px]'>অভিবাবকের তথ্য</h1>
                </div>
            </div>
            <div className='flex items-center justify-start gap-8 mt-4'>
                <div className='w-full'>
