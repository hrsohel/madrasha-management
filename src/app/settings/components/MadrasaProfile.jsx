...
export default function MadrasaProfile() {
    ...
    useEffect(() => {
        if (madrasaSettings) {
            setFormData({
                name: {
                    bangla: madrasaSettings.name?.bangla || '',
                    english: madrasaSettings.name?.english || '',
                    arabic: madrasaSettings.name?.arabic || ''
                },
                location: {
                    bangla: madrasaSettings.location?.bangla || '',
                    english: madrasaSettings.location?.english || '',
                    arabic: madrasaSettings.location?.arabic || ''
                },
                contact: {
                    email: madrasaSettings.contact?.email || '',
                    phone: madrasaSettings.contact?.phone || ''
                },
                logo: null,
            });
    ...
    return (
        <div className="w-[80%] mx-auto">
            <div className='border-[1px] border-gray-200 relative mt-8'>
