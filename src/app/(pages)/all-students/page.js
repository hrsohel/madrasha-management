    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="rounded-md p-4 mb-6 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-9 gap-4">
        {[
          ...
          ["নাজেরা", students.filter(s => s.division === "হিফজ'").length], // Assuming division names need mapping
          ["হিফজ", students.filter(s => s.division === "Hifz").length],
          ["নূরানী ", students.filter(s => s.division === "Sunni").length],
          ["কিতাব", students.filter(s => s.division === "Kitab").length],
        ].map(([label, value], idx) => (
                    ...
                    <td className="p-3">
                      <div className="flex flex-col items-center gap-1 font-semibold">
                        <div className="flex items-center gap-2">
                          <span
                            className={`w-2 h-2 rounded-full ${student.class === "Nazera" ? "bg-yellow-500" :
                        ...
                        <div className="flex items-center justify-center gap-1">
                          <span className="w-6 h-6 rounded-full inline-block">
                            {["সকাল", "Morning"].includes(student.shift) ? (
                              // Morning Shift - Sun Icon
                              <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                              ...
                              >
                                ...
                                <mask
                                  ...
                                  height="19"
                                >
                                  <path d="M-4.62451 -2.78125H28.6222V15.5304H-4.62451V-2.78125Z" fill="white" />
                                </mask>
                                <g mask="url(#mask0_69_7072)">
                                  <g clipPath="url(#clip0_69_7072)">
                                    <path
                                      d="M11.9948 17.2533C14.3044 17.2533 16.1766 15.381 16.1766 13.0715C16.1766 10.7619 14.3044 8.88965 11.9948 8.88965C9.68525 8.88965 7.81299 10.7619 7.81299 13.0715C7.81299 15.381 9.68525 17.2533 11.9948 17.2533Z"
                                      fill="#FFF1C2"
                                      stroke="#E5A000"
                                      strokeWidth="0.298701"
                                      strokeMiterlimit="10"
                                    />
                                    <path
                                      d="M16.5807 8.48425L18.3301 6.73485M5.65724 19.4077L7.40205 17.6629M18.4862 13.0713L20.9565 13.0713M3.03084 13.0713L5.51031 13.0713M11.9982 6.58333L11.9937 4.10845M11.9937 22.0341V19.5546M7.40664 8.49343L5.65265 6.73944M18.3255 19.4123L16.5807 17.6675"
                                      stroke="#E5A000"
                                      strokeWidth="1.19481"
                                      strokeMiterlimit="10"
                                      strokeLinecap="round"
                                ...
                                />
                                <defs>
                                  <clipPath id="clip0_69_7072">
                                    <rect
                                      width="19.1169"
                                      height="19.1169"
                                      fill="white"
                                      transform="translate(2.43506 3.5127)"
                                    />
                                  </clipPath>
                                </defs>
                              </svg>
                            ) : ["বিকাল", "Evening"].includes(student.shift) ? (
                              // Evening Shift - Moon Icon
                              <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                              ...
                              >
                                ...
                                <mask
                                  ...
                                  height="19"
                                >
                                  <path d="M-4.62451 27.4297H28.6222V9.118H-4.62451V27.4297Z" fill="white" />
                                </mask>
                                <g mask="url(#mask0_69_7167)">
                                  <g clipPath="url(#clip0_69_7167)">
                                    <path
                                      d="M11.9948 7.39515C14.3044 7.39515 16.1766 9.26742 16.1766 11.577C16.1766 13.8865 14.3044 15.7588 11.9948 15.7588C9.68525 15.7588 7.81299 13.8865 7.81299 11.577C7.81299 9.26742 9.68525 7.39515 11.9948 7.39515Z"
                                      fill="#FEE9E7"
                                      stroke="#EC221F"
                                      strokeWidth="0.298701"
                                      strokeMiterlimit="10"
                                    />
                                    <path
                                      d="M16.5807 16.1642L18.3301 17.9136M5.65724 5.24077L7.40205 6.98557M18.4862 11.5772L20.9565 11.5772M3.03084 11.5772L5.51031 11.5772M11.9982 18.0651L11.9937 20.54M11.9937 2.61437V5.09383M7.40664 16.155L5.65265 17.909M18.3255 5.23617L16.5807 6.98098"
                                      stroke="#EC221F"
                                      strokeWidth="1.19481"
                                      strokeMiterlimit="10"
                                      strokeLinecap="round"
                                ...
                                <defs>
                                  <clipPath id="clip0_69_7167">
                                    <rect
                                      ...
                                      height="19.1169"
                                      fill="white"
                                      transform="matrix(1 0 0 -1 2.43506 21.1357)"
                                    />
                                  </clipPath>
                                </defs>
                              </svg>
                            ) : null /* or <span></span> if you want to keep the space */}
                          </span>
